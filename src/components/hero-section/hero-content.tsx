...
export const HeroContent = () => {
  return (
    <MaxWidthWrapper className="relative z-20 mx-auto flex h-full flex-col justify-end py-24 md:py-24">
      ...
      >
        We emphasis AI technology to develop large language models (LLMs) to
        empower education in Indonesia
      </motion.h1>
      <motion.p
        initial={{
          y: 25,
      ...
      >
        Welcome to AlteroLabs, We lead in AI development and education by
        cutting-edge AI solutions and efficient IT team-building services. We
        aiming to become the number one AI company and education center in
        Indonesia.
      </motion.p>
      <motion.div
        initial={{
